#
#  Be sure to run `pod spec lint WYQProgressHUD.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source_files  = "MBProgressHUDExtend/*.{h,m}","MBProgressHUDExtend/UIViewController+HUD/*.{h,m}","MBProgressHUDExtend/MBProgressHUD/*.{h,m}"
